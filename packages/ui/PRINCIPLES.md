...
| 4. Contrast is a gate | all tokens, and every measurable pair the 90 previews render: 587 at the last run, 0 failing | 65 rendered pairs sit on images, gradients, canvases or blend modes and are reported, not measured; components still carry pre-token literals |
