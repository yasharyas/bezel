...
/* ── visual and motion / ceremonial / editorial preview wrappers ── */
...
const previews: Record<string, React.ReactNode> = {
  ...
  "circular-text": (
    <div className="flex items-center justify-center p-4">
      <CircularText text="EDITORIAL HOUSE • EST 2024 • " size="sm" />
    </div>
  ),
  "pinched-button": (
